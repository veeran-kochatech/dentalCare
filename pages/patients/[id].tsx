...
const activity = [
  ...
  { id: 3, type: 'treated', person: { name: 'Chelsea Hagon' }, date: '6d ago', dateTime: '2023-01-23T11:24' },
  {
    id: 4,
    type: 'consulted',
    person: {
  ...
  { id: 5, type: 'monitored', person: { name: 'Alex Curren' }, date: '2d ago', dateTime: '2023-01-24T09:12' },
  { id: 6, type: 'discharged', person: { name: 'Alex Curren' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
]
const moods = [
...
export default function Example({params}:any) {
    ...
    const fetchProcedure = (patient:any, id: any) => {
      ...
      axios({
        ...
        setProcedureItems(response.data)
      });
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="bg-white lg:col-start-3 lg:row-end-1">
              ...
              <div className="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
                <dl className="flex flex-wrap bg-white">
                  ...
                  <div className="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6">
                    ...
                    <dd className="text-sm font-medium leading-6 text-gray-900">{patient? patient.patientName:''}</dd>
                  </div>
            ...
            <div className="bg-white -mx-4 px-4 py-8 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
              ...
              <Listbox value={selectedProcedures} onChange={(e)=>getProcedureDetails(e)}>
                {({ open }) => (
                  <>
                      <Listbox.Label className="block font-medium leading-6 font-semibold text-gray-900">Select Treatment</Listbox.Label>
                      <div className="relative mt-2">
                          <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          <span className="block truncate">{selectedProcedures.name}</span>
              ...
              <table className="mt-8 w-full whitespace-nowrap text-left text-sm leading-6">
                ...
                <tbody className='relative'>
                  ...
                  <div className='absolute w-full h-full'>
                    <div className=" w-full h-full z-50 overflow-hidden bg-white opacity-50 flex flex-col items-center justify-center">
                    <div className="loader ease-linear rounded-full border-4 border-t-4 border-black h-12 w-12 mb-4"></div>
                    </div>
                  </div>
                  )}
                  
                  {procedureItems && procedureItems.procedureDetails.map((item:any) => (
                    <tr key={item.id} className="border-b border-gray-100">
                      ...
                      <td className="py-5 pl-8 pr-0 text-right align-top tabular-nums text-gray-700">{item.discountPrice}</td>
                    </tr>
                  ))}
                </tbody>
                <tfoot>
                  <tr>
                    ...
                    <td className="pb-0 pl-8 pr-0 pt-6 text-right tabular-nums text-gray-900">{procedureItems ? procedureItems.totalPrice: 0}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="pb-0 pl-8 pr-0 pt-4 text-right tabular-nums text-gray-900">{procedureItems ? procedureItems.totalDiscount:0}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="pb-0 pl-8 pr-0 pt-4 text-right font-semibold tabular-nums text-gray-900">
                      {procedureItems? procedureItems.total:0}
                    </td>
                  </tr>
                </tfoot>
              </table>
            ...
            <div className="lg:col-start-3 bg-white px-4 py-4 shadow-sm ring-1 ring-gray-900/5 rounded-lg">
              {/* Activity feed */}
